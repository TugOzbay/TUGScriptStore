...
#
# define my Strings
my $Daystring1 = "Monday-Tuesday-Wednesday-Thursday-Friday-*OFFweek*";
...
# WEEK 2
#
my $Daystring2 = "Monday-Tuesday-Wednesday-Thursday-Friday-*OFFweek*";
...
# WEEK 3
#
my $Daystring3 = "Monday-Tuesday-Wednesday-Thursday-Friday-*OFFweek*";
...
# WEEK 4
#
my $Daystring4 = "Monday-Tuesday-Wednesday-Thursday-Friday-*OFFweek*";
...
# WEEK 5
#
my $Daystring5 = "Monday-Tuesday-Wednesday-Thursday-Friday-*OFFweek*";
...
# WEEK 6
#
my $Daystring6 = "Monday-Tuesday-Wednesday-Thursday-Friday-*OFFweek*";
...
#
my $Daystring7 = "Monday-Tuesday-Wednesday-Thursday-Friday-*OFFweek*";
...
sub send_mail {
        ...
        my $recipient = 'tugrul.ozbay@cjcit.com flynn.gardener@cjcit.com brian.daly@cjcit.com paul.kossowski@cjcit.com dave.willis@cjcit.com sam.grayston@cjcit.com ajay.patel@cjcit.c
om';
