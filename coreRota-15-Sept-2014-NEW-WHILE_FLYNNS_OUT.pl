...
# Version       : 1.0007 Prod
# comment       : While flynns out Rota (on 14th Sept 2015 T Ozbay)
...
#
if ($week == 1||$week == 7||$week == 13||$week == 19||$week == 25||$week == 31||$week == 37||$week == 43||$week ==49) {         # works best [1]
#
# WEEK 1
#
# define my Strings
my $Daystring1 = "Monday-Tuesday-Wednesday-Thursday-Friday->>OFF Rota";
my $Engnames1 = "DaveW,PaulK,TugO,BrianD,SamG,JonasM";
#
...
#
#
if ($week == 2||$week == 8||$week == 14||$week == 20||$week == 26||$week == 32||$week == 38||$week == 44||$week ==50) {         # works best [2]
#
# WEEK 2
#
my $Daystring2 = "Monday-Tuesday-Wednesday-Thursday-Friday->>OFF Rota";
my $Engnames2 = "JonasM,DaveW,PaulK,TugO,BrianD,SamG";
#
#transform above strings into arrays with a little cleanup.
...
#
if ($week == 3||$week == 9||$week == 15||$week == 21||$week == 27||$week == 33||$week == 39||$week == 45||$week ==51) {         # works best [3]
#
...
# WEEK 3
#
my $Daystring3 = "Monday-Tuesday-Wednesday-Thursday-Friday->>OFF Rota";
my $Engnames3 = "SamG,JonasM,DaveW,PaulK,TugO,BrianD";
#
#transform above strings into arrays with a little cleanup.
...
#
#
if ($week == 4||$week == 10||$week == 16||$week == 22||$week == 28||$week == 34||$week == 40||$week == 46||$week == 52) {               # works best [4]
# if ($week =~ /(4||10||16||22||28||34||40||46)/) { # issues
#
#
# WEEK 4
#
my $Daystring4 = "Monday-Tuesday-Wednesday-Thursday-Friday->>OFF Rota";
my $Engnames4 = "BrianD,SamG,JonasM,DaveW,PaulK,TugO";
#
#transform above strings into arrays with a little cleanup.
...
#
#
if ($week == 5||$week == 11||$week == 17||$week == 23||$week == 29||$week == 35||$week == 41||$week == 47) {            # works best [5]
# if ($week =~ /(5||11||17||23||29||35||41||47)/) { # issues
#
# WEEK 5
#
my $Daystring5 = "Monday-Tuesday-Wednesday-Thursday-Friday->>OFF Rota";
my $Engnames5 = "TugO,BrianD,SamG,JonasM,DaveW,PaulK";
#
#transform above strings into arrays with a little cleanup.
...
#
#
if ($week == 6||$week == 12||$week == 18||$week == 24||$week == 30||$week == 36||$week == 42||$week == 48) {            # works best [6]
...
# WEEK 6
#
my $Daystring6 = "Monday-Tuesday-Wednesday-Thursday-Friday->>OFF Rota";
my $Engnames6 = "PaulK,TugO,BrianD,SamG,JonasM,DaveW";
#
#transform above strings into arrays with a little cleanup.
...
sub send_mail {
      ...
      # my $recipient = 'tugrul.ozbay@cjcit.com indrek.sepp@cjcit.com flynn.gardener@cjcit.com brian.daly@cjcit.com paul.kossowski@cjcit.com dave.willis@cjcit.com sam.grayston@cjcit.com';
