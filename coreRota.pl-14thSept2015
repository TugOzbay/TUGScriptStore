...
#
if ($week == 1||$week == 8||$week == 15||$week == 22||$week == 29||$week == 36||$week == 43||$week == 50) {             # works best [1]
#
# WEEK 1
#
# define my Strings
my $Daystring1 = "Monday-Tuesday-Wednesday-Thursday-Friday->>OFF Rota->>OFF Rota";
my $Engnames1 = "DaveW,PaulK,TugO,BrianD,SamG,JonasM,FlynnG";
#
...
#
#
if ($week == 2||$week == 9||$week == 16||$week == 23||$week == 30||$week == 37||$week == 44||$week == 51) {             # works best [2]
#
# WEEK 2
#
my $Daystring2 = "Monday-Tuesday-Wednesday-Thursday-Friday->>OFF Rota->>OFF Rota";
my $Engnames2 = "FlynnG,DaveW,PaulK,TugO,BrianD,SamG,JonasM";
#
#transform above strings into arrays with a little cleanup.
...
#
if ($week == 3||$week == 10||$week == 17||$week == 24||$week == 31||$week == 38||$week == 45||$week == 52) {            # works best [3]
#
...
# WEEK 3
#
my $Daystring3 = "Monday-Tuesday-Wednesday-Thursday-Friday->>OFF Rota->>OFF Rota";
my $Engnames3 = "JonasM,FlynnG,DaveW,PaulK,TugO,BrianD,SamG";
#
#transform above strings into arrays with a little cleanup.
...
#
#
if ($week == 4||$week == 11||$week == 18||$week == 25||$week == 32||$week == 39||$week == 46 ) {                # works best [4]
#
#
# WEEK 4
#
my $Daystring4 = "Monday-Tuesday-Wednesday-Thursday-Friday->>OFF Rota->>OFF Rota";
my $Engnames4 = "SamG,JonasM,FlynnG,DaveW,PaulK,TugO,BrianD";
#
#transform above strings into arrays with a little cleanup.
...
#
#
if ($week == 5||$week == 12||$week == 19||$week == 26||$week == 33||$week == 40||$week == 47) {         # works best [5]
#
# WEEK 5
#
my $Daystring5 = "Monday-Tuesday-Wednesday-Thursday-Friday->>OFF Rota->>OFF Rota";
my $Engnames5 = "BrianD,SamG,JonasM,FlynnG,DaveW,PaulK,TugO";
#
#transform above strings into arrays with a little cleanup.
...
#
#
if ($week == 6||$week == 13||$week == 20||$week == 27||$week == 34||$week == 41||$week == 48) {         # works best [6]
#
#       if ($week =~ /(8||24||6)/) {            #
#
# WEEK 6
#
my $Daystring6 = "Monday-Tuesday-Wednesday-Thursday-Friday->>OFF Rota->>OFF Rota";
my $Engnames6 = "TugO,BrianD,SamG,JonasM,FlynnG,DaveW,PaulK";
#
#transform above strings into arrays with a little cleanup.
...
#
#
if ($week == 7||$week == 14||$week == 21||$week == 28||$week == 35||$week == 42||$week == 49) {         # works best [7]
#
# WEEK 7
#
# define my Strings
my $Daystring1 = "Monday-Tuesday-Wednesday-Thursday-Friday->>OFF Rota->>OFF Rota";
my $Engnames1 = "PaulK,TugO,BrianD,SamG,JonasM,FlynnG,DaveW";
#
# transform above strings into arrays with a little cleanup.
my @string1 = split('-', $Daystring1);
my @names1  = split(',', $Engnames1);
...
#
my $Daystring7 = "Monday-Tuesday-Wednesday-Thursday-Friday->>OFF Rota->>OFF Rota";
my $Engnames7 = "blah,blah,blah,blah,blah,Merry Xmas";
#
#transform above strings into arrays with a little cleanup.
...
#        my $recipient = 'tugrul.ozbay@cjcit.com';
        my $recipient = 'tugrul.ozbay@cjcit.com jonas.mogilevec@cjcit.com flynn.gardener@cjcit.com brian.daly@cjcit.com paul.kossowski@cjcit.com dave.willis@cjcit.com sam.grayston@cjcit.com      ';
