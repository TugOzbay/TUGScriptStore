...
# Author        : Tugrul Ozbay
# Date          : 7th Jan 2015
# Reason        : archiving LTC jukka when reaches 50k size and rotates until 10 then it archives
# Version       : 1
# Strict        : Extremely
# Warnings      : None.
#
use strict;
#
my $bizim_dir = "/data01/home/tozbay";   # Jukka yeri
my $bizim_jukka = "tug.wal";             # Jukka adi
my $maxsize = 5_0000;                    # 50k Max buyukluk rotasyon icin
...
## print "$s, $m, $h, $dayOfMonth, $month, $yearOffset, $dow, $doy, $dst\n\n";
#
### Switch directory to where jukka is located
chdir $bizim_dir;
#
### Check Size of Jukka
...
else
{
    ...
    print " *Needs to get to a file size of 50kb - then it will rotate it.\n\n";
}
